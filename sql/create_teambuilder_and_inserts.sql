...
(
    ...
    INDEX `fk_members_status1_idx` (`status_id` ASC),
...
values ('Anthony', 'Anthony''s_Pa$$w0rd', 1, 1),
       ...
       ('Marlène', 'Marlène''s_Pa$$w0rd', 1, 2),
       ('Eléa', 'Eléa''s_Pa$$w0rd', 1, 2),
       ('Thérèse', 'Thérèse''s_Pa$$w0rd', 1, 2),
       ('Pélagie', 'Pélagie''s_Pa$$w0rd', 1, 2),
       ('Clélia', 'Clélia''s_Pa$$w0rd', 2, 2),
       ('Anaé', 'Anaé''s_Pa$$w0rd', 1, 2),
       ('Marie-noël', 'Marie-noël''s_Pa$$w0rd', 1, 2),
       ('Andréanne', 'Andréanne''s_Pa$$w0rd', 1, 2),
